...
У цій главі ми загалом розглядаємо поняття формування діаграми, пеленгації (DOA) і фазованих решіток.  Ми порівнюємо різні типи і геометрії решіток і покажемо, яку важливу роль відіграє відстань між елементами решіток. Такі алгоритми, як MVDR/Capon і MUSIC, будуть представлені і змодельовані в прикладах на Python.

************************
Огляд формування діаграми
************************

Фазовані решітки, також відомі як решітки з електронним керуванням - це сукупність антен, які можуть використовуватися на стороні як передачі так і прийому сигналу для формування діаграми спрямованості в одному або декількох бажаних напрямках.  Вони використовуються як у зв'язку, так і в радіолокації, і ви можете побачити їх використання у наземних, повітряних та супутникових системах. Зазвичай ми називаємо антени, з яких складається решітка, елементами, а іноді решітку називають «датчиком». Ці елементи решітки найчастіше є всеспрямованими антенами, розташованим на одній ліній на однакових відстаях, або на однакових відстанях але за двома осями на площині. 

Формування діаграми спрямованості - це операція обробки сигналу, за допомогою антенних решіток для створення просторового фільтра; він фільтрує сигнали з усіх напрямків, окрім потрібного нам напрямку (напрямків). Формування діаграми спярмованості може використовуватися для підвищення С/Ш (SNR) бажаних сигналів, подавлення перешкод, формування діаграми спрямованості або навіть для передачі/прийому декількох потоків даних одночасно на однакових частотах. У процесі формування діаграми спрямованості ми використовуємо ваги (так звані коефіцієнти), які застосовуються до кожного елемента масиву, як у при цифровій обробці сигналу, так і при аналоговій. Ми маніпулюємо вагами так, щоб сформувати промінь (промені) решітки, звідси і назва - формування діаграми спрямованості. При цьому можно надзвичайно швидко керувати напрямком максимумів і мінімумів цих діаграм; керувати набагато швидше, ніж це можно робити за допомогою механічного керування напрямку антен, яке можно розглядати як альтернативу фазованим решіткам. Зазвичай ми будемо розглядати формування діаграми спрямованості для лінії зв'язку, де приймач має отримати один або кілька сигналів з максимально можливим с/ш (SNR). Антенні решітки також відіграють величезну роль у радіолокації, де треба виявляти і відстежувати цілі.
